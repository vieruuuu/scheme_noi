...
# generate client.exe
nim c --cpu:i386 -t:-m32 -l:-m32 -d:ssl -f --import:"$PWD\src\lib\functions\hideString.nim" -d:isProd=true -d:release -d:danger --opt:size --app:gui --passC:-flto -o:./dist/client.exe ./src/client.nim
