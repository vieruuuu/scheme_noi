...
# generate client.exe
nim c -d:ssl -f -d:isProd=true -d:release -d:danger --opt:size --app:gui --passC:-flto -o:./dist/client.exe ./src/client.nim
...
# generate infect.exe
nim c -f -d:isProd=true -d:release -d:danger --opt:size --app:gui --passC:-flto -o:./dist/infect.exe ./src/infect.nim
strip -s ./dist/infect.exe
